...
export const languageUser = {
    'UA': {
        ...
        userShopView: {
            ...
            userShopSettingColorShopTitle: 'Налаштування вигляду магазину',
            userShopSettingColorTitle: 'Налаштуквання кольорів',
            ...
            userShopSettingBtnTitle: 'Вибір вигляду кнопки',
            ...
            userShopSettingBtnSetStandard: 'Стандартні',
            userShopSettingBtnSetUpdate: 'Оновити',
            userShopInfoSettingColor: 'Налаштування вигляду магазину',
            ...
            userShopBlockUpdateBtn: 'Оновити',
            userShopBlockInstruction: 'Заповніть блок інформацією і нажміть створити.  При заповнні "Опис інформації" блок буде перенаправляти на сторінкуде можна детальніше розказати про інформацію.  Блок появиться на головній сторінці магазину.',
        ...
        usernotifications: {
            userNotificationsTitle: 'Мої повідомлення',
            userNotificationsSortTitle: 'Статус:',
            userNotificationsSortOption1: 'Всі',
            userNotificationsSortOption2: 'Передзвонити',
            userNotificationsSortOption3: 'Підписки',
            userNotificationsFilterTitle: 'Вибрати всі:',
            ...
            userNotificationsFilterDateFormat: 'дд.мм.рррр',
        },
        selectStatus: {
        ...
        readPurchasesView: {
            ...
            readPurchasesInfoDateTitle: 'Дата створення:',
    ...
    'ENG': {
        ...
        userShopView: {
            ...
            userShopSettingColorShopTitle: 'Setting the appearance of the store',
            userShopSettingColorTitle: 'Color settings',
            ...
            userShopSettingBtnTitle: 'Selection of button appearance',
            ...
            userShopSettingBtnSetStandard: 'Standard',
            userShopSettingBtnSetUpdate: 'Update',
            userShopInfoSettingColor: 'Setting the appearance of the store',
            ...
            userShopBlockUpdateBtn: 'Update',
            userShopBlockInstruction: 'Fill in the block with information and click create. When filling in "Description of information", the block will redirect to a page where you can talk about the information in more detail. The block will appear on the main page of the store.',
        ...
        usernotifications: {
            ...
            userNotificationsFilterDateFormat: 'dd.mm.yyyy',
        },
        selectStatus: {
        ...
        readPurchasesView: {
            ...
            readPurchasesInfoDateTitle: 'Date of creation:',
